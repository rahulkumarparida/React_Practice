...
export default function Counter(){
    ...
    return <>
    <h1>{count}</h1>
    <button onClick={(e)=>{  setCount(count+clacby.add);   e.preventDefault()}}>Add</button>
    <button onClick={(e)=>{  setCount(count-clacby.sub);   e.preventDefault()}}>Sub</button>
    <button onClick={(e)=>{  setCalcby({...clacby , add:clacby.add+1});   e.preventDefault()}}>Increase by {clacby.add}</button>
    <button onClick={(e)=>{  setCalcby({...clacby , sub:clacby.sub+1});   e.preventDefault()}}>Decrease by {clacby.sub}</button>
